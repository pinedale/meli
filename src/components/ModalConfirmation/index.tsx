...
const ModalConfirmation: React.FC<ModalConfirmationProps> = ({ isOpen, onClose, confirmDelete }) => {
  ...
  return (
    <div id="popup-modal" className="fixed top-0 left-0 right-0 z-50 p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full bg-gray-500 bg-opacity-50 flex justify-center justify-items-center">
